...
type ServerHandlerOnSetup interface {
	// OnSetup must return a Response and a stream.
	// The stream is needed to:
	// - add the session into stream's readers list
